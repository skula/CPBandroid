...
public class Downloading {
	...
	public static String[] torrentFieldName = new String[] { "downloadDir",
			"id", "leftUntilDone", "percentDone", "rateDownload", "name",
			"status", "totalSize" };

	public static Downloading[] getStaticArray() {
		Downloading torrentArray[] = null;
		torrentArray = new Downloading[10];
		for (int i = 0; i < 10; i++) {
			torrentArray[i] = new Downloading("", i + "", "150", "0.25", "652",
					"djkqsjdkqskdj.torrent", "6", "1250");
		}
		return torrentArray;
	}
	...
	public Downloading(String downloadDir, String id, String leftUntilDone,
			String percentDone, String rateDownload, String name,
			String status, String totalSize) {
	...
	public static void setTorrentFieldName(String[] torrentFieldName) {
		Downloading.torrentFieldName = torrentFieldName;
	}
}